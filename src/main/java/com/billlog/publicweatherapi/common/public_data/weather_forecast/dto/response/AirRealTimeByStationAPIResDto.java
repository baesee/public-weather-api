...
public class AirRealTimeByStationAPIResDto {
    /* 에어코리아 - 측정소별 실시간 측정정보 조회 API 응답 DTO */
    ...
    public static class AirRealTimeByStationDto{
        ...
        public AirRealTimeByStationDto(resultResponse.Items item) {
